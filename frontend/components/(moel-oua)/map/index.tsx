...
const MapView = dynamic(() => import("./map-view"), {
  ssr: false,
  loading: () => (
    <Card className="relative overflow-hidden border-2 border-black bg-[#f4f1ea] shadow-[6px_6px_0px_#000] rounded-3xl flex items-center justify-center h-[600px] w-full">
