...
export default function FullButton({ children, text, backgroundColor, href, className = '', classNameText = '', onClick, type = 'button', disabled = false, tabIndex }: FullButtonProps) {
